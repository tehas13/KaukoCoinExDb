            ...
            <form action="" method="post" class="w-50">
                <div class="row pt-2">
                    <div class="col">
                        ...
                        <?php inputElement("Turimas kce:", "kce",$row['kce']); ?>
                    </div>
                    <div class="col">
                        <?php inputElement("Kam pervesti?", "user",""); ?>
                    </div>
                </div>
                <div class="row pt-2">
                    <div class="col">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <?php buttonElement("btn-perleidimas","btn btn-light","<i class='fas fa-sync'></i>","perleidimas","data-toggle='tooltip' data-placement='bottom' title='Perleidimas'"); ?>
                </div>
